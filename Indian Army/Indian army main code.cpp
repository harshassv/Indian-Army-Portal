...
void set()
{
	system("cls");
	do{
	char n[25],n1[25],c[25],sc[25],dec[25],dei[25],pin[25],pinc[25],usn[25];int a=0,dum_int;
...
//			return;
		...
		else
		{
			...
			system("cls");
			cout<<"\n\n\t\t\t\t\tOOPS :( please check your user name";
			i=1;
	}}while(i);
